...
def set_args():
    ...
    parser.add_argument('--pretrained_model_path', default='./roberta_pretrain', type=str, help='预训练模型的路径')
    parser.add_argument('--output_dir', default='./outputs', type=str, help='模型输出')

    parser.add_argument('--num_train_epochs', default=7, type=int, help='训练几轮')
    parser.add_argument('--train_batch_size', default=8, type=int, help='训练批次大小')
    parser.add_argument('--val_batch_size', default=8, type=int, help='验证批次大小')
